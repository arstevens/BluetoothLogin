...
class RSSI_snatcher(object):
	...
	def _get_median(self,dataset):
		...
		for phone in dataset:
			if phone[0] != self._address:
				odd_values.append(phone)
		if odd_values:
	...
	def get_device_strength(self,bluetooth_address):
		#returns a tuple containing address and rssi value 

		self._address = bluetooth_address
		dev_id = bluez.hci_get_route(bluetooth_address)
		try:
